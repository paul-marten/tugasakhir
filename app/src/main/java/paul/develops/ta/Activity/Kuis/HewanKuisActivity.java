...
public class HewanKuisActivity extends AppCompatActivity {
    ...
    Question currentQ;
    TextView times, scored , nomorsoal;
    ImageView imgHewan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hewan_kuis);
...
//        txtQuestion = (TextView) findViewById(R.id.txtQuestion);
        imgHewan = (ImageView) findViewById(R.id.imgKuisHewan);
        // the textview in which the question will be displayed

        // the three buttons,
        // the idea is to set the text of three buttons with the options from question bank
        button1 = (Button) findViewById(R.id.button1Kuis);
        button2 = (Button) findViewById(R.id.button2Kuis);
        button3 = (Button) findViewById(R.id.button3Kuis);

        // the textview in which score will be displayed
        scored = (TextView) findViewById(R.id.scoreHewan);
        nomorsoal = (TextView) findViewById(R.id.txtNomorSoalHewan);
        // the timer
        times = (TextView) findViewById(R.id.timersHewan);
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(HewanKuisActivity.this,
