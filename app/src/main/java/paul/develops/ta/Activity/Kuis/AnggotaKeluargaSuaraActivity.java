...
public class AnggotaKeluargaSuaraActivity extends AppCompatActivity {

    MediaPlayer mediaPlayer;
    List<KeluargaSuara> quesList;
    int score = 0;
    int qid = 0;

    RestClient restClient;

    KeluargaSuara currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anggota_keluarga_suara);
        DBHelper db = new DBHelper(this);  // my question bank class
        quesList = db.getAllSuaraKeluarga();  // this will fetch all quetonall questions
        currentQ = quesList.get(qid); // the current question

//        txtQuestion = (TextView) findViewById(R.id.txtQuestion);
        imgHewan = (ImageView) findViewById(R.id.imgKuisAngSuara);
        // the textview in which the question will be displayed

        // the three buttons,
        // the idea is to set the text of three buttons with the options from question bank
        button1 = (Button) findViewById(R.id.button1KuisSuaraAng);
        button2 = (Button) findViewById(R.id.button2KuisSuaraAng);
        button3 = (Button) findViewById(R.id.button3KuisSuaraAng);

        // the textview in which score will be displayed
        scored = (TextView) findViewById(R.id.scoreAngSuara);

        // the timer
        times = (TextView) findViewById(R.id.timersAngSuara);
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(AnggotaKeluargaSuaraActivity.this,
